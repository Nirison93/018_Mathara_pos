                ...
                <div class="bg-white/40 backdrop-blur-xl rounded-xl p-4 shadow-lg border border-white/60 mb-6">
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        :value="categoryCodePreview"
                        type="text"
                        disabled
                        class="w-full px-3 py-2 text-sm text-gray-500 bg-gray-100 border border-gray-300 rounded-lg cursor-not-allowed"
                      />
                    </div>
...
const categoryCodePreview = computed(() => {
  return (form.name || '').trim().slice(0, 3).toUpperCase();
});
